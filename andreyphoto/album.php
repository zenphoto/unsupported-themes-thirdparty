...
<td>
	...
	<tr valign='top'>
		...
		<?php } elseif ($zi >= 8) { ?>
			...
			?>
					...
					<?php if ($zi != 8) { ?>
						<tr><td colspan='7' style='line-height:10px;height:10px'></td></tr>
					<?php } ?>
					<tr>
			<?php } elseif ($zi2 == 2) { ?>
				<td style='width:10px'>&nbsp;</td>
	...
	<tr valign='top'>
		...
		<?php } ?>
			<td class='image_td'>
				<div class="imagethumb"><a href="<?php echo getImageLinkURL();?>" title="<?php echo getImageTitle();?>"><?php //printImageThumb(getImageTitle()); ?><?php printCustomSizedImage(getImageTitle(), null, 168, 168, 168, 168); ?></a></div>
			</td>
			<?php if ($zi < 4) { ?>
				<td style='width:10px'>&nbsp;</td>
			<?php } ?>
