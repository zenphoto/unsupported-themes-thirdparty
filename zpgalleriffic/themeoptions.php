	...
	function getOptionsSupported() {
		return array(	
						...
						gettext('Tagline') => array('key' => 'zpgal_tagline', 'type' => OPTION_TYPE_TEXTBOX, 
							'order' => 2,
							'multilingual' => 1, 'desc' => gettext('The text to include in the metatag title on the homepage.')),
						...
						gettext('ZenPage Latest News on Home page') => array('key' => 'zpgal_zp_latestnews', 'type' => OPTION_TYPE_TEXTBOX, 
							'order' => 7,
						...
						gettext('   -> Latest News Truncation') => array('key' => 'zpgal_zp_latestnews_trunc', 'type' => OPTION_TYPE_TEXTBOX, 
							'order' => 8,
						...
						gettext('   -> Home Page: Galleriffic Height') => array('key' => 'zpgal_minigalheight', 'type' => OPTION_TYPE_TEXTBOX, 
							'order' => 12,
						...
						gettext('   -> Home Page: Galleriffic Image Count') => array('key' => 'zpgal_minigalcount', 'type' => OPTION_TYPE_TEXTBOX, 
							'order' => 13,
						...
						gettext('   -> Archive Image Count') => array('key' => 'zpgal_archivecount', 'type' => OPTION_TYPE_TEXTBOX, 
							'order' => 17,
						...
						gettext('Galleriffic Slide Transition Delay') => array('key' => 'zpgal_delay', 'type' => OPTION_TYPE_TEXTBOX, 
							'order' => 19,
							'desc' => gettext('Default is \'6000\'.')),
						gettext('Galleriffic # of Thumbs') => array('key' => 'zpgal_thumbcount', 'type' => OPTION_TYPE_TEXTBOX, 
							'order' => 20,
							'desc' => gettext('Default is \'9\'.')),
						gettext('Galleriffic # of Images to Preload') => array('key' => 'zpgal_preload', 'type' => OPTION_TYPE_TEXTBOX, 
							'order' => 21,
						...
						gettext('Colorbox Slideshow Speed') => array('key' => 'zpgal_cbssspeed', 'type' => OPTION_TYPE_TEXTBOX, 
							'order' => 25,
