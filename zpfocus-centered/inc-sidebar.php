		<div class="left">
			...
			if ((in_context(ZP_ALBUM)) || (in_context(ZP_IMAGE))) { $sstype = 'album'; $ssalbum = $_zp_current_album->getFolder(); $sstitle = gettext('Random Album Image'); } else { $sstype = 'all'; $ssalbum = null; $sstitle = gettext('Random Gallery Image'); }
			?>
			<div id="random-wrap">
