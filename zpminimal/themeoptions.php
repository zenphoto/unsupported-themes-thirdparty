...
class ThemeOptions {
	...
	function getOptionsSupported() {
		return array(
			...
			gettext('Album Thumb Size') => array('key' => 'zpmin_album_thumb_size', 'type' => OPTION_TYPE_TEXTBOX, 'desc' => gettext('Select the size of album thumbs. The thumb size above is for image thumbs. Album thumbs will also take on your selection of cropping or not.  A good size for albums is 158 (3 per row), and a good size above for image thumbs is 113 (4 per row). Make sure you also set the number of thumbs per row for images and albums above! ')),
			gettext('Menu Name of Menu Manager') => array('key' => 'zpmin_menu', 'type' => OPTION_TYPE_TEXTBOX, 'desc' => gettext('If you use the menu manager plugin, enter the name of the menu you would like to use.  Make sure you create the menu in the menu manager backend! Or leave blank to use the theme menu.')),
			gettext('ZenPage Search Results') => array('key' => 'zpmin_zpsearchcount', 'type' => OPTION_TYPE_TEXTBOX, 'desc' => gettext('If using Zenpage, enter the number of search results to display for each news and pages.  Default is 2 (4 total possible).')),
