...
class ThemeOptions {
	...
	function getOptionsSupported() {
		return array(
			...
			gettext('Logo Height') => array('key' => 'zpmas_logoheight', 'type' => OPTION_TYPE_TEXTBOX,
				'order' => 8,
			...
			gettext('ZenPage Search Results') => array('key' => 'zpmas_zpsearchcount', 'type' => OPTION_TYPE_TEXTBOX,
				'order' => 11,
			...
			gettext('Frontpage Slideshow Count') => array('key' => 'zpmas_sscount', 'type' => OPTION_TYPE_TEXTBOX,
				'order' => 18,
			...
			gettext('Frontpage Slideshow Speed?') => array('key' => 'zpmas_ssspeed', 'type' => OPTION_TYPE_TEXTBOX,
				'order' => 20,
